 ...
 * customTagPrefix为空时只输出：className.methodName(Line:lineNumber)。 http://blog.csdn.net/finddreams
 */
public class LogUtils {

  private static String customTagPrefix = "shanxigas"; // 自定义Tag的前缀，可以是作者名
